/******************************************************************************
 *  Compilation:  javac utils.In.java
 *  Execution:    java utils.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
   ...
   /**
    ...
    public In(File file) {
        ...
        try {
            // for consistency with utils.StdIn, wrap with BufferedInputStream instead of use
   ...
   /**
     ...
     * @deprecated Replaced by {@code new utils.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new utils.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
   ...
   /**
     ...
     * @deprecated Replaced by {@code new utils.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
   ...
   /**
     * Unit tests the {@code utils.In} data type.
     *
