 ...
 *  Execution:    java utils.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code utils.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code utils.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">utils.StdIn.java</a>
 ...
 *      double value = utils.StdIn.readDouble();
 *      utils.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (utils.StdIn.hasNextChar()) {
 *      char c = utils.StdIn.readChar();
 *      utils.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (utils.StdIn.hasNextLine()) {
 *      String line = utils.StdIn.readLine();
 ...
 *  <pre>
 *  String[] words = utils.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code utils.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code utils.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code utils.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code utils.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code utils.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code utils.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code utils.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code utils.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code utils.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from utils.In to utils.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from utils.In to utils.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from utils.In to utils.StdIn,
   ...
   /**
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)utils.In.readChar() error!"
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from utils.In to utils.StdIn
