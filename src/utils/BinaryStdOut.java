/******************************************************************************
 *  Compilation:  javac utils.BinaryStdOut.java
 *  Execution:    java utils.BinaryStdOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code utils.BinaryStdOut} with calls
 *  to {@code utils.StdOut} or {@code System.out}; otherwise unexpected behavior
 *  will result.
 *
...
public final class BinaryStdOut {
    ...
    private static boolean isInitialized;     // has utils.BinaryStdOut been called for first time?

    // don't instantiate
    private BinaryStdOut() { }

    // initialize utils.BinaryStdOut
