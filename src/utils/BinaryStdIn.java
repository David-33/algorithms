/******************************************************************************
 *  Compilation:  javac utils.BinaryStdIn.java
 *  Execution:    java utils.BinaryStdIn < input > output
 *  Dependencies: none
 *
 *  Supports reading binary data from standard input.
 *
 *  % java utils.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code utils.BinaryStdIn} with calls
 *  to {@code utils.StdIn} or {@code System.in};
...
public final class BinaryStdIn {
    ...
    private static boolean isInitialized;   // has utils.BinaryStdIn been called for first time?
   ...
   /**
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close utils.BinaryStdIn", ioe);
        }
    }
