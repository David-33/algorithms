/******************************************************************************
 *  Compilation:  javac utils.BinaryOut.java
 *  Execution:    java utils.BinaryOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code utils.BinaryOut} with calls
 *  to {@code utils.Out}; otherwise unexpected behavior will result.
 *
