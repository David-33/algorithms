/******************************************************************************
 *  Compilation:  javac utils.BinaryIn.java
 *  Execution:    java utils.BinaryIn input output
 *  Dependencies: none
 *
 *  This library is for reading binary data from an input stream.
 *
 *  % java utils.BinaryIn https://introcs.cs.princeton.edu/java/cover.png output.png
 *
 ******************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code utils.BinaryIn} with calls
 *  to {@code utils.In}; otherwise unexpected behavior will result.
 *
...
public final class BinaryIn {
   ...
   /**
     * Unit tests the {@code utils.BinaryIn} data type.
